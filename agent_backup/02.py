...
- "Remove the priority column" → Actually drops the column
...
- "Delete all completed tasks" → Actually deletes the records
- "Add a new column" → Modifies the table immediately
...
def main():
    ...
    """
    print(" Real-Time Database Agent Starting...")
    print("=" * 60)
    ...
    try:
        ...
        print("The AI executes your requests immediately!")
        print("=" * 60)
        ...
        print("Please check your database connection and GOOGLE_API_KEY.")
